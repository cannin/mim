...
/**
 * The main class for the MIM-GPML converter. Converts MIMML documents to GPML
 * Pathways
 * 
 ...
 * 
 */
public class MIMGPMLPlugin implements Plugin {
	...
	public void init(PvDesktop desktop) {
		// Required to retrieve MIM line types
