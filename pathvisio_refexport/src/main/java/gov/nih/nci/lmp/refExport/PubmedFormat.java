...
import gov.nih.nci.lmp.refExport.PubmedExporterHelper;
...
/** 
 * Sets up the Pubmed format in Pathvisio
 * 
 * @author Augustin Luna <augustin@mail.nih.gov>
 */
public class PubmedFormat implements PathwayExporter {
	...
	public void doExport(File file, Pathway pathway) throws ConverterException {
		try {
			PubmedExporterHelper helper = new PubmedExporterHelper(pathway);
			helper.export(file);
		} catch (IOException e) {
